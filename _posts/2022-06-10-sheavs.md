...
There is alternative way to describe the identity and gluability axioms, which gets at both axioms at once. For any open cover $\mathfrak{U} = \\{U_i \\}_\{i \in I}$ of an open set $U \subset X$, define the maps 
